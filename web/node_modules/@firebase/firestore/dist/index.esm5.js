 ...
 * limitations under the License.
 */
var P = "9.1.3", F = new h("@firebase/firestore");
    ...
    return t.prototype.start = function(t, e) {
        ...
        setTimeout((function() {
            if (!i.auth) {
                ...
                q("FirebaseCredentialsProvider", "Auth not yet detected"), a.resolve(), a = new Y);
            }
        }), 0), u();
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            ...
            if ("\\" === a) {
                ...
                var u = t[i + 1];
                if ("\\" !== u && "." !== u && "`" !== u) throw new W(H.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += u, i += 2;
...
/** Extracts the backend's type order for the provided value. */ function xt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? St(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : j();
}
...
var Zt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.R(t, e, r) : new te(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ie(t, r) : "in" /* IN */ === e ? new oe(t, r) : "not-in" /* NOT_IN */ === e ? new se(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new ae(t, r) : new n(t, e, r);
    }, n.R = function(t, e, n) {
...
/** Creates a new Query instance with the options provided. */ function ye(t, e, n, r, i, o, s, a) {
    return new pe(t, e, n, r, i, o, s, a);
}
 ...
 */ function Ee(t) {
    ...
    if (!e.S) if ("F" /* First */ === e.limitType) e.S = Yt(e.path, e.collectionGroup, Te(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                var a = e.endAt ? new ue(e.endAt.position, !e.endAt.before) : null, u = e.startAt ? new ue(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.S = Yt(e.path, e.collectionGroup, n, e.filters, e.limit, a, u);
    }
    return e.S;
}
 ...
 */ function Pe(t, e, n) {
    ...
    }(n, e) : t instanceof qe ? Ue(t, e) : t instanceof Be ? Ke(t, e) : function(t, e) {
 ...
 */ function Fe(t, e, n) {
    ...
    // applications.
    return t instanceof qe ? Ue(t, e) : t instanceof Be ? Ke(t, e) : n;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && st(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof qe && e instanceof qe || t instanceof Be && e instanceof Be ? st(t.elements, e.elements, Lt) : t instanceof je && e instanceof je ? Lt(t.C, e.C) : t instanceof Ve && e instanceof Ve;
 ...
 */ function an(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, Pe(a, u, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var un, cn, hn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (cn = un || (un = {}))[cn.OK = 0] = "OK", cn[cn.CANCELLED = 1] = "CANCELLED", 
    ...
    t.prototype.ft = function(t) {
        ...
        if (r) {
            ...
            if ($t(i)) if (0 === n) {
                ...
                // queries.
                var o = new Ct(i.path);
                this.at(e, o, Ht.newNoDocument(o, ct.min()));
        ...
        this.et.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && $t(o.target)) {
                    ...
                    null !== e.nt.get(s) || e.gt(i, s) || e.at(i, s, Ht.newNoDocument(s, t));
                }
                r.K && (n.set(i, r.W()), r.G());
            }
        }));
...
function Xn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? pt.emptyPath() : Zn(e);
}
    ...
    var n = e.currentDocument ? function(t) {
        ...
        return function(t, e) {
            ...
            if ("setToServerValue" in e) z("REQUEST_TIME" === e.setToServerValue), n = new Ve; else if ("appendMissingElements" in e) {
                ...
                n = new Be(i);
            } else "increment" in e ? n = new je(t, e.increment) : j();
...
function or(t, e) {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = ur(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = ur(e.endAt)), n;
}
...
function sr(t) {
    ...
    var h = null;
    return n.endAt && (h = cr(n.endAt)), ye(e, i, a, s, u, "F" /* First */ , c, h);
}
...
function pr(t) {
    return Zt.create(dr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return u.db = r.sent(), e = Kr.open(u.db, t, n ? "readonly" : "readwrite", i), a = o(e).catch((function(t) {
 ...
 */ var Zr = /** @class */ function() {
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && $e(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && $e(s, t, this.localWriteTime);
        }
    }, 
    /**
...
/** Decodes a remote document from storage locally to a Document. */ function ri(t, e) {
    ...
    if (e.noDocument) {
        var n = Ct.fromSegments(e.noDocument.path), r = ui(e.noDocument.readTime), i = Ht.newNoDocument(n, r);
...
/** Encodes a document for storage locally. */ function ii(t, e, n) {
    ...
    if (e.isNoDocument()) {
        var a = e.key.path.toArray(), u = ai(e.version), c = e.hasCommittedMutations;
        return new kr(
        /* unknownDocument= */ null, new Dr(a, u), 
        /* document= */ null, c, r, i);
    }
    if (e.isUnknownDocument()) {
        var h = e.key.path.toArray(), f = ai(e.version);
...
/** Decodes a DbTarget into TargetData */ function hi(t) {
    var e, n, r = ui(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? ui(t.lastLimboFreeSnapshotVersion) : ct.min();
...
function fi(t, e) {
    ...
    n = $t(e.target) ? ir(t.Wt, e.target) : or(t.Wt, e.target);
 ...
 */
function Ti(t, e, n) {
    var r = t.store(Nr.store), i = t.store(_r.store), o = [], s = IDBKeyRange.only(n.batchId), a = 0, u = r.Kt({
        range: s
    }, (function(t, e, n) {
        return a++, n.delete();
    }));
...
var Si = /** @class */ function() {
    ...
    return t.Yt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(a) {
            ...
            }(i.N, i.userId, u), h = [], f = new gn((function(t, e) {
                return ot(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = _r.key(i.userId, p.key.path, a);
    ...
    t.prototype.Xt = function(t, e) {
        ...
        return e.forEach((function(e) {
            var o = _r.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), a = Di(t).Kt({
                range: s
            }, (function(t, i, o) {
                var s = t[0], a = t[1], u = t[2], c = Ir(a);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
        ...
        var n = this, r = e.path, i = r.length + 1, o = _r.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), a = new gn(ot);
        return Di(t).Kt({
            range: s
        }, (function(t, e, o) {
            var s = t[0], u = t[1], c = t[2], h = Ir(u);
 ...
 */ var ki = /** @class */ function() {
    ...
    t.prototype.ce = function(t, e) {
        ...
        var n = gr(e.path), r = IDBKeyRange.bound([ n ], [ at(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Ri(t).Kt({
 ...
 */ var Bi = /** @class */ function() {
    ...
    t.prototype.ve = function(t, e) {
        ...
        return Qi(t).Kt(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var a = ri(r.N, n);
                e.path.isPrefixOf(a.key.path) ? Ae(e, a) && (i = i.insert(a.key, a)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, s) {
            ...
            if (s.document.isValidDocument()) {
                var u = ii(e.Se.N, s.document, e.getReadTime(o));
...
var Ji = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Xi = /** @class */ function() {
    ...
    h) {
        ...
        this.Ge = new jr(this.We, 11, new Wi(this.N)), this.ze = new Ci(this.referenceDelegate, this.N), 
    ...
    t.prototype.Xe = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Zi(e).put(new Pr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
        ...
        var e = this;
        return $i(t).get(Er.key).next((function(t) {
    ...
    t.prototype.rn = function(t) {
        var e = this;
        return this.Me ? Br.resolve(!0) : $i(t).get(Er.key).next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Zi(t).Lt().next((function(t) {
    ...
    t.prototype.pn = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Zi(e).Lt().next((function(e) {
 ...
 */
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Cn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, a = o.mutations; s < a.length; s++) {
                    ...
                    h = Ht.newInvalidDocument(c), r = r.insert(c, h)), $e(u, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
        ...
        for (var r = Dn(), i = 0, o = e; i < o.length; i++) for (var s = 0, a = o[i].mutations; s < a.length; s++) {
            var u = a[s];
            u instanceof rn && null === n.get(u.key) && (r = r.add(u.key));
        }
        var c = n;
...
function go(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = Q(t), i = In(), o = oi(n), s = Qi(e), a = IDBKeyRange.lowerBound(o, !0);
            return s.Kt({
 ...
 */ function bo(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = Q(t), s = Dn(), a = In(), u = Nn(), c = 0, h = i; c < h.length; c++) f = h[c], 
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return fo(t, d, a, ct.min(), u).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ var To = /** @class */ function() {
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        for (var s = 0, a = r; s < a.length; s++) {
            var u = a[s];
            this.ds = this.ds.add(new So(u.key, i)), this.Ht.addToCollectionParentIndex(t, u.key.path.popLast());
        }
        return Br.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
    ...
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return this.ae(e), this.targetCount += 1, Br.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.ae(e), Br.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        return this.Es.delete(e.target), this.As.cs(e.targetId), this.targetCount -= 1, 
        Br.resolve();
    }, t.prototype.removeTargets = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.Es.forEach((function(s, a) {
            a.sequenceNumber <= e && null === n.get(a.targetId) && (r.Es.delete(s), o.push(r.removeMatchingKeysForTargetId(t, a.targetId)), 
            i++);
...
var Po = /** @class */ function() {
                    ...
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Ws.test(i.key)) {
                                ...
                                return e;
                            }(i.newValue), a !== nt.T && this.sequenceNumberHandler(a); else if (i.key === this.Js) return [ 2 /*return*/ , this.syncEngine.wi() ];
                        } else this.Ks.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
    ...
    return t(n, e), n.prototype.qi = function(t, e, n, r) {
        ...
        var a = r.createWebChannel(s, o), u = !1, c = !1, h = new Go({
            vi: function(t) {
                c ? q("Connection", "Not sending because WebChannel is closed:", t) : (u || (q("Connection", "Opening WebChannel transport."), 
                a.open(), u = !0), q("Connection", "WebChannel sending:", t), a.send(t));
            },
            Vi: function() {
                return a.close();
            }
 ...
 */ var Jo = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.sr = 0, this.ir = null, this.stream = null, this.rr = new Jo(t, e)
        /**
    ...
    t.prototype.mr = function() {}, t.prototype.auth = function() {
        ...
        this.stream = this.Tr(t), this.stream.Si((function() {
            n((function() {
    ...
    t.prototype.gr = function(t) {
        ...
        return function(n) {
            e.Oe.enqueueAndForget((function() {
                return e.sr === t ? n() : (q("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return t(n, e), n.prototype.Tr = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                n = new On(r, i, o, a || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var u = e.documentChange;
                u.document, u.document.name, u.document.updateTime;
                var c = Yn(t, u.document.name), h = Gn(u.document.updateTime), f = new Gt({
                    mapValue: {
                        fields: u.document.fields
                    }
                }), l = Ht.newFoundDocument(c, h, f), d = u.targetIds || [], p = u.removedTargetIds || [];
    ...
    n.prototype.Ir = function(t) {
        var e = {};
        e.database = $n(this.N), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = $t(r) ? {
                documents: ir(t, r)
            } : {
                query: or(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = jn(t, e.resumeToken) : e.snapshotVersion.compareTo(ct.min()) > 0 && (
    ...
    n.prototype.Ar = function(t) {
        var e = {};
        e.database = $n(this.N), e.removeTarget = t, this.wr(e);
    }, n;
}(Xo), Zo = /** @class */ function(e) {
    function n(t, n, r, i, o) {
        var s = this;
    ...
    n.prototype.start = function() {
        ...
        z(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Rr) {
        ...
        // The first response is always the handshake response
                return z(!t.writeResults || 0 === t.writeResults.length), this.Rr = !0, 
        this.listener.Vr();
    }, 
    /**
    ...
    return t(n, e), n.prototype.Cr = function() {
        if (this.Dr) throw new W(H.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.$r ? (U(e), this.$r = !1) : q("OnlineStateTracker", e);
...
e, i, o, s) {
    ...
    /**
             ...
             */
    this.jr = [], this.Qr = s, this.Qr.Ti((function(t) {
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = Q(t)).Kr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , is(e) ];
 ...
 */ function ss(t, e) {
    var n = Q(t), r = _s(n);
    n.qr.delete(e), r.cr() && us(n, e), 0 === n.qr.size && (r.cr() ? r.lr() : fs(n) && 
...
function hs(t) {
    return fs(t) && !_s(t).ar() && t.qr.size > 0;
}
...
function ys(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(u) {
            switch (u.label) {
              case 0:
                if (t.Wr.set("Online" /* Online */), !(e instanceof On && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 6:
                if (e instanceof Ln ? t.Gr.rt(e) : e instanceof Rn ? t.Gr.ft(e) : t.Gr.ct(e), i.isEqual(ct.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;

              case 7:
                return u.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , co(t.localStore) ];
              ...
              case 11:
                return q("RemoteStore", "Failed to raise snapshot:", a = u.sent()), [ 4 /*yield*/ , vs(t, a) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Kr.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , is(t) ];
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Kr.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , rs(t) ];
...
function gs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = Q(t), n = Ds(e), i = e.Ur.length > 0 ? e.Ur[e.Ur.length - 1].batchId : -1, r.label = 1;
...
function ws(t) {
    return fs(t) && !Ds(t).ar() && t.Ur.length > 0;
}
...
function Ts(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = Ds(t), n = 0, i = t.Ur; n < i.length; n++) o = i[n], e.Pr(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function Es(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.Ur.shift(), o = ti.from(n, e, i), [ 4 /*yield*/ , ms(t, (function() {
...
function Ss(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && Ds(t).br ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return dn(i = e.code) && i !== H.ABORTED ? (n = t.Ur.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                Ds(t).hr(), [ 4 /*yield*/ , ms(t, (function() {
 ...
 */ function Ns(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = Q(t), e ? (n.Kr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , rs(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.Kr.add(2 /* IsSecondary */), [ 4 /*yield*/ , is(n) ]);
    ...
    t.zr = function(t, e, n) {
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.zr.hr(), hs(t) ? cs(t) : t.Wr.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function Ds(t) {
    ...
    t.Hr = function(t, e, n) {
        var r = Q(t);
        return r.Cr(), new Zo(e, r.nr, r.credentials, r.N, n);
    }(t.datastore, t.asyncQueue, {
        Si: Is.bind(null, t),
        Ci: Ss.bind(null, t),
        Vr: Ts.bind(null, t),
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Hr.hr(), [ 4 /*yield*/ , gs(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.Ur.length > 0 && (q("RemoteStore", "Stopping write stream with " + t.Ur.length + " pending writes"), 
                    t.Ur = []), e.label = 4;
 ...
 */ var Cs = /** @class */ function() {
    ...
    this.queries = new Bi((function(t) {
        return _e(t);
    }), Ne), this.onlineState = "Unknown" /* Unknown */ , this.Zr = new Set;
};
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 4:
                ...
                e.eo(n.onlineState), s.Xr && e.no(s.Xr) && qs(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Us = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.eo = function(t) {
        ...
        t = Ls.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.io = !0, 
        this.so.next(t);
    }, t;
}(), Bs = /** @class */ function() {
    function t(t, 
    ...
    return t.prototype.fo = function(t) {
        ...
        for (var e = new Map, n = new Ks(this.N), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , bo(this.localStore, new Ks(this.N), this.documents, this.lo.id) ];
 ...
 */ var Gs = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = Dn(), this.po = ke(t), this.To = new Cs(this.po);
    }
    return Object.defineProperty(t.prototype, "Eo", {
        /**
    ...
    t.prototype.Io = function(t, e) {
        var n = this, r = e ? e.Ao : new xs, i = e ? e.To : this.To, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, a = !1, u = me(this.query) && i.size === this.query.limit ? i.last() : null, c = ge(this.query) && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        return this.mo = a, 0 !== o.length || u ? {
            snapshot: new Ls(this.query, t.To, i, o, t.mutatedKeys, 0 /* Local */ === a, u, 
            /* excludesMetadataChanges= */ !1),
            vo: s
        } : {
            vo: s
    ...
    t.prototype.bo = function(t) {
        ...
        // updating many documents.
                var e = this.yo;
        this.yo = Dn(), this.To.forEach((function(e) {
            t.Vo(e.key) && (t.yo = t.yo.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.yo.has(e) || n.push(new Qs(e));
    ...
    t.prototype.Do = function() {
        return Ls.fromInitialDocuments(this.query, this.To, this.mutatedKeys, 0 /* Local */ === this.mo);
    }, t;
}(), Ws = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.No = {}, this.xo = new Bi((function(t) {
            return _e(t);
        }), Ne), this.ko = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.Oo = new yn(Ct.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Fo = new Map, this.Mo = new Eo, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Lo = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Bo = new Map, this.Uo = ki.ie(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(l) {
            switch (l.label) {
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view.Io(i), n.Ln ? [ 4 /*yield*/ , vo(t.localStore, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (fa(t, e.targetId, a.vo), 
                                    a.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                return s = l.sent(), a = new Hs(e, s.Gn), u = a.Io(s.documents), c = xn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = a.applyChanges(u, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), fa(t, i, h.vo), f = new Ws(e, i, a), 
...
/** Stops listening to the query. */ function Zs(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = Q(t), i = n.xo.get(e), (o = n.ko.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.ko.set(i.targetId, o.filter((function(t) {
                    return !Ne(t, e);
              ...
              case 3:
                return ca(n, i.targetId), [ 4 /*yield*/ , yo(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = Q(t), i = ut.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), Dn());
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new yn(ot)), r = r.insert(e, n), t.Lo[t.currentUser.toKey()] = r;
              ...
              case 5:
                return s = r.sent(), a = ks(s, "Failed to persist write"), i.reject(a), [ 3 /*break*/ , 6 ];
            ...
            switch (r.label) {
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    t.addedDocuments.size > 0 ? r.Co = !0 : t.modifiedDocuments.size > 0 ? z(r.Co) : t.removedDocuments.size > 0 && (z(r.Co), 
                    r.Co = !1));
                })), [ 4 /*yield*/ , pa(n, i, e) ];
 ...
 */ function na(t, e, n) {
    ...
    // SharedClientState.
        ...
        }(r.eventManager, e), i.length && r.No.Er(i), r.onlineState = e, r.isPrimaryClient && r.sharedClientState.setOnlineState(e);
    }
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = Q(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Fo.get(e), 
                (s = o && o.key) ? (a = (a = new yn(Ct.comparator)).insert(s, Ht.newNoDocument(s, ct.min())), 
                u = Dn().add(s), c = new Cn(ct.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new gn(ot), a, u), [ 4 /*yield*/ , ea(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Oo = n.Oo.remove(s), n.Fo.delete(e), da(n), [ 3 /*break*/ , 4 ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                ua(n, i, /*error=*/ null), aa(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , pa(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                // listen events.
                ua(n, e, i), aa(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , pa(n, o) ];
...
function ua(t, e, n) {
    var r = Q(t), i = r.Lo[r.currentUser.toKey()];
...
function ha(t, e) {
    ...
    var n = t.Oo.get(e);
    null !== n && (ss(t.remoteStore, n), t.Oo = t.Oo.remove(e), t.Fo.delete(n), da(t));
}

function fa(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Gs ? (t.Mo.addReference(o.key, e), la(t, o)) : o instanceof Qs ? (q("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function la(t, e) {
    ...
    t.Oo.get(n) || t.$o.has(r) || (q("SyncEngine", "New document in limbo: " + n), t.$o.add(r), 
    da(t));
}
 ...
 */ function da(t) {
    for (;t.$o.size > 0 && t.Oo.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.$o.delete(e);
        var n = new Ct(pt.fromString(e)), r = t.Uo.next();
        t.Fo.set(r, new Ys(n)), t.Oo = t.Oo.insert(n, r), os(t.remoteStore, new ei(Ee(ve(n.path)), r, 2 /* LimboResolution */ , nt.T));
    }
}
...
function pa(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = Q(t), s = [], a = [], u = [], o.xo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.xo.forEach((function(t, n) {
              ...
              case 1:
                return c.sent(), o.No.Er(s), [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
...
function va(t, e) {
    var n = Q(t), r = n.Fo.get(e);
    if (r && r.Co) return Dn().add(r.key);
    var i = Dn(), o = n.ko.get(e);
    if (!o) return i;
    for (var s = 0, a = o; s < a.length; s++) {
        var u = a[s], c = n.xo.get(u);
        i = i.unionWith(c.view.Eo);
    }
    return i;
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return i = r.sent(), o = e.view.So(i), [ 2 /*return*/ , (n.isPrimaryClient && fa(n, e.targetId, o.vo), 
                o) ];
            }
        }));
    }));
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Fo.forEach((function(t, n) {
                        ss(e.remoteStore, n);
                    })), e.Mo.us(), e.Fo = new Map, e.Oo = new yn(Ct.comparator);
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return s < a.length ? (u = a[s], c = void 0, (h = n.ko.get(u)) && 0 !== h.length ? [ 4 /*yield*/ , po(n.localStore, Ee(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.xo.get(d), [ 4 /*yield*/ , ma(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , mo(n.localStore, u) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , po(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , $s(n, Ta(v), u, 
                /*current=*/ !1) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                return s = r.sent(), a = Cn.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , pa(n, s, a) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(p) {
            switch (p.label) {
              ...
              case 3:
                return c = p.sent(), [ 4 /*yield*/ , $s(n, Ta(u), c.targetId, 
                /*current=*/ !1) ];
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.ko.has(t) ? [ 4 /*yield*/ , yo(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
...
function _a(t) {
    ...
    e.remoteStore.remoteSyncer.rejectListen = ra.bind(null, e), e.No.Er = Ms.bind(null, e.eventManager), 
    e.No.jo = Vs.bind(null, e.eventManager), e;
}

function Da(t) {
    var e = Q(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = ia.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = oa.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(zs(n)), o = new js(n, t.localStore, e.N), [ 4 /*yield*/ , e.Qo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return u = r.sent(), [ 4 /*yield*/ , pa(t, u.En, 
                    /* remoteEvent */ void 0) ];
...
var ka = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.N = Yo(t.databaseInfo.databaseId), this.sharedClientState = this.Wo(t), 
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 3:
                    ...
                    return r.sent(), [ 4 /*yield*/ , Da(this.Jo.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , gs(this.Jo.remoteStore) ];
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.Jo.syncEngine, this.sharedClientState instanceof Uo ? (this.sharedClientState.syncEngine = {
                        _i: wa.bind(null, i),
                        mi: Sa.bind(null, i),
                        gi: Na.bind(null, i),
                        pn: Ea.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.nn((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , ba(this.Jo.syncEngine, t) ];
    ...
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return na(n.syncEngine, t, 1 /* SharedClientState */);
        ...
        }, o = jo.bt() ? new jo : new Ko, new ns(e, n, r, i, o);
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = Q(t), q("RemoteStore", "RemoteStore shutting down."), e.Kr.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , is(e) ];
 ...
 */ var Oa = /** @class */ function() {
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = Q(t), i = $n(n.N) + "/documents", o = {
    ...
    function t(t, e, n, r) {
        ...
        this.aa = 5, this.rr = new Jo(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.rr.Xi((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Fa(this.datastore), (e = this.ua(t)) && e.then((function(e) {
                ...
                return a.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , ao(e.localStore, t) ];
...
function Ua(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , Ba(t) ];
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    ...
                                    n.Kr.add(3 /* CredentialChange */), [ 4 /*yield*/ , is(n) ];
                                  ...
                                  case 2:
                                    return r.sent(), n.Kr.delete(3 /* CredentialChange */), [ 4 /*yield*/ , rs(n) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                ...
                n.onUnlisten = Zs.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function Wa(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new Y;
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function ru(t) {
 ...
 */ var su = /** @class */ function() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new su({}), 
        this._settingsFrozen = !1, t instanceof Xa ? this._databaseId = t : (this._app = t, 
        this._databaseId = function(t) {
            ...
            return new Xa(t.options.projectId);
        }(t));
    }
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new su(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new X;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */
        return t = this, (e = $a.get(t)) && (q("ComponentProvider", "Removing Datastore"), 
        $a.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ function lu(t, n) {
    ...
    if (t = b(t), Za("collection", "path", n), t instanceof au) {
        var o = pt.fromString.apply(pt, e([ n ], r));
        return nu(o), new fu(t, /* converter= */ null, o);
    }
    if (!(t instanceof cu || t instanceof fu)) throw new W(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(pt.fromString.apply(pt, e([ n ], r)));
    return nu(s), new fu(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function du(t, e) {
    if (t = iu(t, au), Za("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new W(H.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new hu(t, 
    /* converter= */ null, 
    /**
...
function pu(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = it.I()), Za("doc", "path", n), t instanceof au) {
        var o = pt.fromString.apply(pt, e([ n ], r));
    ...
    if (!(t instanceof cu || t instanceof fu)) throw new W(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(pt.fromString.apply(pt, e([ n ], r)));
    return eu(s), new cu(t.firestore, t instanceof fu ? t.converter : null, new Ct(s));
}
 ...
 * Firestore database.
 */ function yu(t, e) {
    return t = b(t), e = b(e), (t instanceof cu || t instanceof fu) && (e instanceof cu || e instanceof fu) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function vu(t, e) {
    return t = b(t), e = b(e), t instanceof hu && e instanceof hu && t.firestore === e.firestore && Ne(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var mu = /** @class */ function() {
    function t() {
        ...
        this.rr = new Jo(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Ta = function() {
            var e = Wo();
            e && q("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.rr.tr();
        };
        var e = Wo();
...
var wu = /** @class */ function() {
    ...
    function n(t, n) {
        ...
        /**
             ...
             */
        return (r = e.call(this, t, n) || this).type = "firestore", r._queue = new mu, r._persistenceKey = "name" in t ? t.name : "[DEFAULT]", 
        r;
    }
...
function Nu(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new Ja(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new Va(t._credentials, t._queue, r);
}
 ...
 */ function _u(t, e) {
    Fu(t = iu(t, Iu));
    var n = Su(t), r = t._freezeSettings(), i = new La;
    return Au(n, i, new Ca(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Du(t) {
    Fu(t = iu(t, Iu));
    var e = Su(t), n = t._freezeSettings(), r = new La;
    return Au(e, r, new xa(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , qa(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Ua(t, e) ];
                    ...
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return jr.bt() ? (e = t + "main", [ 4 /*yield*/ , jr.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
 ...
 */ function xu(t) {
                    ...
                    switch (r.label) {
                      ...
                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = Q(t);
                            return e.Kr.delete(0 /* UserDisabled */), rs(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (Su(t = iu(t, Iu)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = Q(t)).Kr.add(0 /* UserDisabled */), [ 4 /*yield*/ , is(e) ];
...
function Ou(t, e) {
    var i = Su(t = iu(t, Iu)), o = new wu;
    return function(t, e, i, o) {
        var s = this, a = function(t, e) {
            return function(t, e) {
                return new Pa(t, e);
            }(function(t, e) {
                if (t instanceof Uint8Array) return Ra(t, e);
                if (t instanceof ArrayBuffer) return Ra(new Uint8Array(t), e);
...
function Pu(t, e) {
    ...
    }(Su(t = iu(t, Iu)), e).then((function(e) {
...
/** A "context" object passed around while parsing user data. */ var Qu = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Ca = function(e) {
        ...
        return lc(t, this.settings.methodName, this.settings.Ma || !1, this.path, this.settings.La);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Gu(this.Da) && Ku.test(t)) throw this.Fa('Document fields cannot begin and end with "__"');
    }, t;
}(), Hu = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse document data from a set() call. */ function Yu(t, e, n, r, i, o) {
    ...
    if (o.merge) a = new mt(s.fieldMask), u = s.fieldTransforms; else if (o.mergeFields) {
        ...
        a = new mt(h), u = s.fieldTransforms.filter((function(t) {
            return a.covers(t.field);
        }));
    } else a = null, u = s.fieldTransforms;
    return new ju(new Gt(c), a, u);
}
...
var $u = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new je(t.N, Re(t.N, this.qa));
...
/** Parse update data from a list of field/value arguments. */ function rc(t, e, n, r, i, o) {
    ...
    for (var h = [], f = Gt.empty(), l = a.length - 1; l >= 0; --l) if (!dc(h, a[l])) {
        var d = a[l], p = u[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = b(p);
    ...
    var m = new mt(h);
    return new zu(f, m, s.fieldTransforms);
}
 ...
 */ function ic(t, e, n, r) {
    return void 0 === r && (r = !1), oc(n, t.Ba(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function oc(t, e) {
    ...
    // from firestore-exp.
    t = b(t))) return uc("Unsupported field value:", e, t), sc(t, e);
    if (t instanceof Uu) 
    ...
    return function(t, e) {
        ...
        if (!Gu(e.Da)) throw e.Fa(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Fa("Unsupported field value: " + ru(t));
    }(t, e);
}
...
function ac(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ut || t instanceof Bu || t instanceof qu || t instanceof cu || t instanceof Uu);
}
...
function lc(t, e, n, r, i) {
    ...
    u += ")"), new W(H.INVALID_ARGUMENT, (a += ". ") + t + u)
 ...
 */
function vc(t, e) {
    return "string" == typeof e ? fc(t, e) : e instanceof Mu ? e._internalPath : e._delegate._internalPath;
}
...
var Cc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new hu(t.firestore, t.converter, Se(t._query, this.Ga, this.za));
    }, n;
}(Sc);
 ...
 * @returns The created {@link Query}.
 */ function xc(t) {
    return ou("limit", t), new Cc("limit", t, "F" /* First */)
    /**
...
function Lc(t) {
    return ou("limitToLast", t), new Cc("limitToLast", t, "L" /* Last */);
}
...
var Rc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = qc(t, this.type, this.Ha, this.Ja);
        return new hu(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function qc(t, e, n, r) {
    if (n[0] = b(n[0]), n[0] instanceof pc) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], s = 0, a = Te(t); s < a.length; s++) {
            var u = a[s];
            if (u.field.isKeyField()) o.push(Vt(e, r.key)); else {
                var c = r.data.field(u.field);
                if (St(c)) throw new W(H.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + u.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
...
function Uc(t, e, n) {
    ...
    if (n instanceof cu) return Vt(t, n._key);
    throw new W(H.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ru(n) + ".");
}
 ...
 */ var jc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new Bu(Tt(t.latitude), Tt(t.longitude));
        ...
        z(mr(n));
        var r = new Xa(n.get(1), n.get(3)), i = new Ct(n.popFirst(5));
        return r.isEqual(e) || 
...
var Gc = /** @class */ function(e) {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = Hc(t, this._firestore), i = zc(r.converter, e, n), o = Yu(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof Mu ? rc(this._dataReader, "WriteBatch.update", s._key, e, n, r) : nc(this._dataReader, "WriteBatch.update", s._key, e), 
 ...
 */ function Wc(t) {
    t = iu(t, cu);
    var e = iu(t.firestore, Iu);
    return Wa(Su(e), t._key).then((function(n) {
        return uh(e, t, n);
    }));
}
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return n = r.sent(), o = new Hs(e, n.Gn), s = o.Io(n.documents), a = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(a.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return u = r.sent(), c = ks(u, "Failed to execute query '" + e + " against cache"), 
...
function eh(t, e, n) {
    t = iu(t, cu);
    var r = iu(t.firestore, Iu), i = zc(t.converter, e, n);
    return ah(r, [ Yu(Wu(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, We.none()) ]);
}

function nh(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = iu(t, cu);
    var o = iu(t.firestore, Iu), s = Wu(o);
    return ah(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = b(e)) || e instanceof Mu ? rc(s, "updateDoc", t._key, e, n, r) : nc(s, "updateDoc", t._key, e)).toMutation(t._key, We.exists(!0)) ]);
}
 ...
 */ function rh(t) {
    return ah(iu(t.firestore, Iu), [ new hn(t._key, We.none()) ]);
}
 ...
 */ function ih(t, e) {
    var n = iu(t.firestore, Iu), r = pu(t), i = zc(t.converter, e);
    return ah(n, [ Yu(Wu(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, We.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function oh(t) {
    ...
    "object" != typeof s[c] || gu(s[c]) || (u = s[c], c++);
    var h, f, l, d = {
    ...
    if (t instanceof cu) f = iu(t.firestore, Iu), l = ve(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](uh(f, t, e));
        },
        error: s[c + 1],
        ...
        var y = iu(t, hu);
        f = iu(y.firestore, Iu), l = y._query;
        var v = new Yc(f);
        h = {
            next: function(t) {
    ...
    return function(t, e, i, o) {
        var s = this, a = new Oa(o), u = new Us(e, a, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
 ...
 */ var ch = /** @class */ function(e) {
    ...
    return t.prototype.get = function(t) {
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof Mu ? rc(this._dataReader, "Transaction.update", s._key, e, n, r) : nc(this._dataReader, "Transaction.update", s._key, e), 
...
P = i, o(new c("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new Iu(r, new Z(t.getProvider("auth-internal")));
    return n = Object.assign({
        useFetchStreams: !0
    }, n), i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), s(R, "3.1.1", undefined), 
// BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
s(R, "3.1.1", "esm5");

export { jc as AbstractUserDataWriter, qu as Bytes, bu as CACHE_SIZE_UNLIMITED, fu as CollectionReference, cu as DocumentReference, gc as DocumentSnapshot, Mu as FieldPath, Uu as FieldValue, Iu as Firestore, W as FirestoreError, Bu as GeoPoint, wu as LoadBundleTask, hu as Query, Sc as QueryConstraint, wc as QueryDocumentSnapshot, bc as QuerySnapshot, mc as SnapshotMetadata, ut as Timestamp, ch as Transaction, Qc as WriteBatch, Xa as _DatabaseId, Ct as _DocumentKey, X as _EmptyCredentialsProvider, vt as _FieldPath, iu as _cast, G as _debugAssert, gt as _isBase64Available, B as _logWarn, tu as _validateIsNotUsedTogether, ih as addDoc, ph as arrayRemove, dh as arrayUnion, ku as clearIndexedDbPersistence, lu as collection, du as collectionGroup, uu as connectFirestoreEmulator, rh as deleteDoc, fh as deleteField, Lu as disableNetwork, pu as doc, Vu as documentId, _u as enableIndexedDbPersistence, Du as enableMultiTabIndexedDbPersistence, xu as enableNetwork, Vc as endAt, Mc as endBefore, Su as ensureFirestoreConfigured, ah as executeWrite, Wc as getDoc, Jc as getDocFromCache, Xc as getDocFromServer, $c as getDocs, Zc as getDocsFromCache, th as getDocsFromServer, Eu as getFirestore, yh as increment, Tu as initializeFirestore, xc as limit, Lc as limitToLast, Ou as loadBundle, Pu as namedQuery, oh as onSnapshot, sh as onSnapshotsInSync, kc as orderBy, Nc as query, vu as queryEqual, yu as refEqual, hh as runTransaction, lh as serverTimestamp, eh as setDoc, V as setLogLevel, Tc as snapshotEqual, Pc as startAfter, Oc as startAt, Ru as terminate, nh as updateDoc, Cu as waitForPendingWrites, Dc as where, vh as writeBatch };
