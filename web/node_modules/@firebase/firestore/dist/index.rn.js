...
class eo {
    constructor(t, e, n, s, i, r) {
         ...
         * close.
         */
        this.sr = 0, this.ir = null, this.stream = null, this.rr = new to(t, e);
    }
    /**
     ...
     */    async close(t, e) {
        ...
        this.rr.Yi()) : e && e.code === j.UNAUTHENTICATED && 
     ...
     */    gr(t) {
        return e => {
            this.Oe.enqueueAndForget((() => this.sr === t ? e() : (O("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class no extends eo {
     ...
     */    Ar(t) {
        const e = {};
        e.database = Zn(this.N), e.removeTarget = t, this.wr(e);
    }
}
 ...
 */ class so extends eo {
    ...
    onMessage(t) {
        ...
        U(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Rr) {
        ...
        return U(!t.writeResults || 0 === t.writeResults.length), this.Rr = !0, this.listener.Vr();
    }
    /**
     ...
     */    Sr() {
        ...
        const t = {};
        t.database = Zn(this.N), this.wr(t);
    }
...
class io extends class {} {
    ...
    Cr() {
        if (this.Dr) throw new Q(j.FAILED_PRECONDITION, "The client has already been terminated.");
    }
...
class ro {
    ...
    Mr(t) {
        ...
        this.$r ? (F(e), this.$r = !1) : O("OnlineStateTracker", e);
    }
    Br() {
        ...
        this.jr = [], this.Qr = i, this.Qr.Ti((t => {
            n.enqueueAndForget((async () => {
                ...
                await async function(t) {
                    const e = K(t);
                    e.Kr.add(4 /* ConnectivityChange */), await ao(e), e.Wr.set("Unknown" /* Unknown */), 
                    e.Kr.delete(4 /* ConnectivityChange */), await co(e);
                }(this));
            }));
        })), this.Wr = new ro(n, s);
    }
...
async function co(t) {
    if (mo(t)) for (const e of t.jr) await e(/* enabled= */ !0);
}
 ...
 */ function ho(t, e) {
    const n = K(t), s = xo(n);
    n.qr.delete(e), s.ar() && fo(n, e), 0 === n.qr.size && (s.ar() ? s.lr() : mo(n) && 
 ...
 */ function _o(t) {
    return mo(t) && !xo(t).cr() && t.qr.size > 0;
}

function mo(t) {
    return 0 === K(t).Kr.size;
}
...
async function To(t, e, n) {
    ...
    t.Wr.set("Online" /* Online */), e instanceof $n && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await Eo(t, n);
    } else if (e instanceof xn ? t.Gr.rt(e) : e instanceof kn ? t.Gr.ft(e) : t.Gr.at(e), 
 ...
 */ async function Eo(t, e, n) {
    ...
    await ao(t), t.Wr.set("Offline" /* Offline */), n || (
    ...
    t.asyncQueue.enqueueRetryable((async () => {
        O("RemoteStore", "Retrying IndexedDB access"), await n(), t.Kr.delete(1 /* IndexedDbFailed */), 
        await co(t);
    }));
}
...
function Po(t) {
    return mo(t) && !ko(t).cr() && t.Ur.length > 0;
}
...
async function Do(t, e, n) {
    const s = t.Ur.shift(), i = ri.from(s, e, n);
...
async function Co(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, wn(n) && n !== j.ABORTED) {
            ...
            // restart.
                        ko(t).hr(), await Io(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
...
async function No(t, e) {
    const n = K(t);
    e ? (n.Kr.delete(2 /* IsSecondary */), await co(n)) : e || (n.Kr.add(2 /* IsSecondary */), 
    await ao(n), n.Wr.set("Unknown" /* Unknown */));
}
 ...
 */ (t.datastore, t.asyncQueue, {
        ...
        e ? (t.zr.hr(), _o(t) ? wo(t) : t.Wr.set("Unknown" /* Unknown */)) : (await t.zr.stop(), 
        go(t));
    }))), t.zr;
}
 ...
 */ function ko(t) {
    ...
    t.Hr = function(t, e, n) {
        const s = K(t);
        return s.Cr(), new so(e, s.nr, s.credentials, s.N, n);
    }(t.datastore, t.asyncQueue, {
        Si: Vo.bind(null, t),
        Ci: Co.bind(null, t),
        Vr: So.bind(null, t),
        ...
        await Ao(t)) : (await t.Hr.stop(), t.Ur.length > 0 && (O("RemoteStore", `Stopping write stream with ${t.Ur.length} pending writes`), 
        t.Ur = []));
    }))), t.Hr;
}
 ...
 */ class Go {
    ...
    ao(t) {
        t = Lo.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.io = !0, 
        this.so.next(t);
    }
}
 ...
 */ class Jo {
     ...
     */    async complete() {
        const t = await Rr(this.localStore, new Ho(this.N), this.documents, this.lo.id), e = this.wo(this.documents);
 ...
 */ class tc {
    ...
    e) {
        ...
        this.mutatedKeys = Vn(), this.po = Se(t), this.To = new Fo(this.po);
    }
    /**
     ...
     */    Io(t, e) {
        const n = e ? e.Ao : new Mo, s = e ? e.To : this.To;
 ...
 */ (t.type, e.type) || this.po(t.doc, e.doc))), this.bo(n);
        ...
        if (this.mo = o, 0 !== i.length || c) {
            return {
                snapshot: new Lo(this.query, t.To, s, i, t.mutatedKeys, 0 /* Local */ === o, c, 
                /* excludesMetadataChanges= */ !1),
                vo: r
            };
        }
    ...
    Po() {
        ...
        // updating many documents.
                const t = this.yo;
        this.yo = Vn(), this.To.forEach((t => {
            this.Vo(t.key) && (this.yo = this.yo.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.yo.has(t) || e.push(new Zo(t));
        })), this.yo.forEach((n => {
    ...
    // PORTING NOTE: Multi-tab only.
    Do() {
        return Lo.fromInitialDocuments(this.query, this.To, this.mutatedKeys, 0 /* Local */ === this.mo);
    }
}
 ...
 */ class sc {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.No = {}, this.xo = new Wi((t => Pe(t)), be), 
        this.ko = new Map, 
        /**
         ...
         * active target.
         */
        this.Oo = new mn(Vt.comparator), 
        /**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */
        this.Fo = new Map, this.Mo = new vr, 
 ...
 */ async function rc(t, e, n, s) {
    ...
    t.Ko = (e, n, s) => async function(t, e, n, s) {
        ...
        return yc(t, e.targetId, o.vo), o.snapshot;
    }(t, e, n, s);
    const i = await Tr(t.localStore, e, 
    /* usePreviousResults= */ !0), r = new tc(e, i.Gn), o = r.Io(i.documents), c = Nn.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), a = r.applyChanges(o, 
...
/** Stops listening to the query. */ async function oc(t, e) {
    const n = K(t), s = n.xo.get(e), i = n.ko.get(s.targetId);
    if (i.length > 1) return n.ko.set(s.targetId, i.filter((t => !be(t, e)))), void n.xo.delete(e);
 ...
 */ async function ac(t, e) {
    ...
    try {
        ...
        // Update `receivedDocument` as appropriate for any limbo targets.
            ...
            t.addedDocuments.size > 0 ? s.Co = !0 : t.modifiedDocuments.size > 0 ? U(s.Co) : t.removedDocuments.size > 0 && (U(s.Co), 
            s.Co = !1));
        })), await Ec(n, t, e);
    } catch (t) {
        await Li(t);
 ...
 */ async function hc(t, e, n) {
    ...
    if (r) {
        ...
        s.Oo = s.Oo.remove(r), s.Fo.delete(e), Tc(s);
...
function gc(t, e) {
    ...
    const n = t.Oo.get(e);
    null !== n && (ho(t.remoteStore, n), t.Oo = t.Oo.remove(e), t.Fo.delete(n), Tc(t));
}

function yc(t, e, n) {
    for (const s of n) if (s instanceof Xo) t.Mo.addReference(s.key, e), pc(t, s); else if (s instanceof Zo) {
        O("SyncEngine", "Document no longer in limbo: " + s.key), t.Mo.removeReference(s.key, e);
...
function pc(t, e) {
    ...
    t.Oo.get(n) || t.$o.has(s) || (O("SyncEngine", "New document in limbo: " + n), t.$o.add(s), 
    Tc(t));
}
 ...
 */ function Tc(t) {
    for (;t.$o.size > 0 && t.Oo.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.$o.delete(e);
        const n = new Vt(lt.fromString(e)), s = t.Uo.next();
        t.Fo.set(s, new nc(n)), t.Oo = t.Oo.insert(n, s), uo(t.remoteStore, new oi(Ae(me(n.path)), s, 2 /* LimboResolution */ , Z.T));
    }
}
 ...
 */ async function Rc(t, e) {
    ...
    return n.isPrimaryClient && yc(n, e.targetId, i.vo), i;
}
...
async function vc(t, e) {
    ...
    if (xc(n), kc(n), !0 === e && !0 !== n.qo) {
        ...
        function(t) {
            ...
            e.Fo.forEach(((t, n) => {
                ho(e.remoteStore, n);
            })), e.Mo.us(), e.Fo = new Map, e.Oo = new mn(Vt.comparator);
        }
        /**
...
async function Vc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            for (const t of n) {
                const e = s.xo.get(t), n = await Rc(s, e);
...
async function Cc(t, e, n, s) {
    ...
    O("SyncEngine", "Ignoring unexpected query state notification."); else if (i.ko.has(e)) switch (n) {
      case "current":
      case "not-current":
        {
...
function xc(t) {
    ...
    e.remoteStore.remoteSyncer.rejectListen = hc.bind(null, e), e.No.Er = jo.bind(null, e.eventManager), 
...
class Oc {
    ...
    async initialize(t) {
        this.N = Zr(t.databaseInfo.databaseId), this.sharedClientState = this.Wo(t), this.persistence = this.Go(t), 
 ...
 */ class Fc extends Oc {
    ...
    async initialize(t) {
        ...
        await kc(this.Jo.syncEngine), await Ao(this.Jo.remoteStore), 
 ...
 */ class Mc extends Fc {
    ...
    async initialize(t) {
        ...
        await this.persistence.nn((async t => {
            await vc(this.Jo.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    Wo(t) {
        const e = Yr();
 ...
 */ class Lc {
    ...
    terminate() {
        return async function(t) {
            const e = K(t);
            O("RemoteStore", "RemoteStore shutting down."), e.Kr.add(5 /* Shutdown */), await ao(e), 
            e.Qr.shutdown(), 
...
class jc {
    constructor(t, e, n, s) {
        ...
        this.cc = 5, this.rr = new to(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    ac() {
        this.rr.Xi((async () => {
            const t = new Kc(this.datastore), e = this.uc(t);
            e && e.then((e => {
...
async function Gc(t, e) {
    ...
    t.setCredentialChangeListener((t => async function(t, e) {
        ...
        // new mutations from the LocalStore (since mutations are per-user).
                n.Kr.add(3 /* CredentialChange */), await ao(n), s && 
        // Don't set the network status to Unknown if we are offline.
        n.Wr.set("Unknown" /* Unknown */), await n.remoteSyncer.handleCredentialChange(e), 
        n.Kr.delete(3 /* CredentialChange */), await co(n);
...
/** Enables the network connection and re-enqueues all pending operations. */ function ea(t) {
    return t.asyncQueue.enqueue((async () => {
        ...
        return e.setNetworkEnabled(!0), function(t) {
            const e = K(t);
            return e.Kr.delete(0 /* UserDisabled */), co(e);
        }(n);
    }));
}
...
/** Disables the network connection. Pending operations will not complete. */ function na(t) {
    return t.asyncQueue.enqueue((async () => {
        ...
        return e.setNetworkEnabled(!1), async function(t) {
            const e = K(t);
            e.Kr.add(0 /* UserDisabled */), await ao(e), 
...
function ra(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            /* usePreviousResults= */ !0), i = new tc(e, s.Gn), r = i.Io(s.documents), o = i.applyChanges(r, 
            /* updateLimboDocuments= */ !1);
 ...
 */ class Na {
    constructor() {
        ...
        this.rr = new to(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Ec = () => {
            const t = Xr();
            t && O("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.rr.tr();
        };
        const t = Xr();
    ...
    enterRestrictedMode(t) {
        if (!this.wc) {
            ...
            const e = Xr();
            e && "function" == typeof e.removeEventListener && e.removeEventListener("visibilitychange", this.Ec);
        }
    }
    enqueue(t) {
        if (this.Ic(), this.wc) 
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = $o.createAndSchedule(this, t, e, n, (t => this.bc(t)));
...
/** A "context" object passed around while parsing user data. */ class cu {
    ...
    Mc(t) {
        return vu(t, this.settings.methodName, this.settings.Lc || !1, this.path, this.settings.Bc);
    }
    ...
    $c(t) {
        ...
        if (ou(this.Cc) && su.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
    }
}
...
class mu extends eu {
    ...
    _toFieldTransform(t) {
        const e = new Ke(t.N, xe(t.N, this.Kc));
...
/** Parse update data from a list of field/value arguments. */ function yu(t, e, n, s, i, r) {
    const o = t.Uc(1 /* Update */ , e, n), c = [ Ru(e, s, n) ], a = [ i ];
 ...
 */ function pu(t, e, n, s = !1) {
    return Tu(n, t.Uc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */
    return function(t, e) {
        ...
        if (!ou(e.Cc)) throw e.Mc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.Mc(`Unsupported field value: ${ya(t)}`);
    }
    /**
...
class Qu extends Lu {
    ...
    _apply(t) {
        return new ba(t.firestore, t.converter, Re(t._query, this.zc, this.Hc));
    }
}
...
class zu extends Lu {
    ...
    _apply(t) {
        const e = th(t, this.type, this.Jc, this.Yc);
        return new ba(t.firestore, t.converter, function(t, e) {
...
function Th(t, ...e) {
    ...
    return function(t, e, n, s) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => qo(await ta(t), r))), () => {
            i.Xo(), t.asyncQueue.enqueueAndForget((async () => Ko(await ta(t), r)));
        };
    }(La(u), h, c, a);
}
...
Nh = "rn", function(t) {
    ...
    const n = t.getProvider("app").getImmediate(), s = new Oa(n, new J(t.getProvider("auth-internal")));
    return e = Object.assign({
        useFetchStreams: !0
    }, e), s._setSettings(e), s;
}), "PUBLIC" /* PUBLIC */)), s(D, "3.1.1", Nh), 
